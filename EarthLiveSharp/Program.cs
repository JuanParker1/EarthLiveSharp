...
namespace EarthLiveSharp
{
    ...
    public class Scraper_himawari8 : IScraper
    {
        ...
        private string json_url = "https://ncthmwrwbtst.cr.chiba-u.ac.jp/img/FULL_24h/latest.json";
        ...
        private int SaveImage()
        {
            ...
            {
               image_source = "https://res.cloudinary.com/" + Cfg.cloud_name + "/image/fetch/https://ncthmwrwbtst.cr.chiba-u.ac.jp/img/D531106";
            }
            else
            {
               image_source = "https://ncthmwrwbtst.cr.chiba-u.ac.jp/img/D531106";
            }
            string url = "";
            string image_path = "";
            try
        ...
        public void CleanCDN()
        {
            ...
            try
            {
                HttpWebRequest request = WebRequest.Create("https://api.cloudinary.com/v1_1/" + Cfg.cloud_name + "/resources/image/fetch?prefix=https://ncthmwrwbtst") as HttpWebRequest;
